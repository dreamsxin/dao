...
Dao\Aop::addBefore('MyServices->doAdminStuff()', 'Advice::forDoAdmin');
Dao\Aop::addAfter('MyServices->doCount()', 'Advice::forCount');
Dao\Aop::addAround('MyServices->doHello()', 'Advice::forHello');
