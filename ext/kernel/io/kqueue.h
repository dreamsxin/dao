...
#ifndef DAO_KERNEL_IO_KQUEUE_H
#define DAO_KERNEL_IO_KQUEUE_H
...
typedef struct kevent dao_io_poll_event;
...
#define DAO_IO_OP(pev)				(pev->flags)
#define DAO_IO_EV(pev)				(pev->filter)
#define DAO_IO_DATA(pev)			(pev->udata)
#define DAO_IO_READ_EV(pev)			(pev->filter == EVFILT_READ)
#define DAO_IO_WRITE_EV(pev)		(pev->filter == EVFILT_WRITE)
#define DAO_IO_IGNORE_EV(pev)		((pev->flags&EV_DELETE) | ((pev->filter==EVFILT_WRITE) & (pev->flags&EV_ERROR)))
#define DAO_IO_TRUE_EOF_EV(pev)		(pev->flags & EV_EOF)
#define DAO_IO_FALSE_EOF_EV(pev)	(pev->flags & EV_EOF)
