...
#ifndef DAO_KERNEL_IO_NETWORKS_H
#define DAO_KERNEL_IO_NETWORKS_H
...
int  dao_io_validate_network  ( void *tpi, struct sockaddr *client_address, char *address_string );
void dao_io_release_networks  ( void *tpi );

#endif /* DAO_KERNEL_IO_NETWORKS_H */
