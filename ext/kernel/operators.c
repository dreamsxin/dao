...
int dao_is_equal_long(zval *op1, zend_long op2) {
	...
	return dao_is_equal(op1, &op2_zval);
}
 ...
 */
double dao_safe_div_long_long(zend_long op1, zend_long op2) {
	if (!op2) {
 ...
 */
double dao_safe_div_long_double(zend_long op1, double op2) {
	if (!op2) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
 ...
 */
double dao_safe_div_double_long(double op1, zend_long op2) {
	if (!op2) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
 ...
 */
double dao_safe_div_double_double(double op1, double op2) {
	if (!op2) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
 ...
 */
double dao_safe_div_zval_long(zval *op1, zend_long op2) {
	if (!op2) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
	...
	return ((double) dao_get_numberval(op1)) / (double) op2;
}

/**
 * Do safe divisions between two zval/double
 */
double dao_safe_div_zval_double(zval *op1, double op2) {
	if (!op2) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
	...
	return ((double) dao_get_numberval(op1)) / op2;
}

/**
 * Do safe divisions between two long/zval
 */
double dao_safe_div_long_zval(zend_long op1, zval *op2) {
	if (!dao_get_numberval(op2)) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
	switch (Z_TYPE_P(op2)) {
	...
	return (double) op1 / ((double) dao_get_numberval(op2));
}

/**
 * Do safe divisions between two double/zval
 */
double dao_safe_div_double_zval(double op1, zval *op2) {
	if (!dao_get_numberval(op2)) {
		zend_error(E_WARNING, "Division by zero");
		return 0;
	}
	...
	return op1 / ((double) dao_get_numberval(op2));
}
...
zend_long dao_safe_mod_zval_long(zval *op1, zend_long op2) {
	...
	return ((zend_long) dao_get_numberval(op1)) % (zend_long) op2;
}
...
zend_long dao_safe_mod_long_zval(zend_long op1, zval *op2) {
	...
	return op1 % ((zend_long) dao_get_numberval(op2));
}
...
zend_long dao_safe_mod_double_zval(double op1, zval *op2) {
	...
	return (zend_long) op1 % ((zend_long) dao_get_numberval(op2));
}
 ...
 * Makes fast count on implicit array types
 */
void dao_fast_count(zval *result, zval *value)
{
	zval retval = {};
 ...
 */
int dao_fast_count_ev(zval *value)
{
	zval retval = {};
	zend_long count = 0;
