 ...
 */
zend_class_entry *dao_mvc_model_query_builder_where_ce;

PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, setConditions);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getConditions);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, where);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, andWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, orWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, betweenWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, notBetweenWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, inWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, notInWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getWhere);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, compile);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getPhql);
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getQuery);

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_setconditions, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_where, 0, 0, 1)
	ZEND_ARG_INFO(0, conditions)
	ZEND_ARG_TYPE_INFO(0, bindParams, IS_ARRAY, 1)
	ZEND_ARG_TYPE_INFO(0, bindTypes, IS_ARRAY, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_andwhere, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, conditions, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, bindParams, IS_ARRAY, 1)
	ZEND_ARG_TYPE_INFO(0, bindTypes, IS_ARRAY, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_orwhere, 0, 0, 1)
	ZEND_ARG_INFO(0, conditions)
	ZEND_ARG_INFO(0, bindParams)
	ZEND_ARG_INFO(0, bindTypes)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_betweenwhere, 0, 0, 3)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_notbetweenwhere, 0, 0, 3)
	ZEND_ARG_INFO(0, expr)
	ZEND_ARG_INFO(0, minimum)
	ZEND_ARG_INFO(0, maximum)
	ZEND_ARG_INFO(0, useOrWhere)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_inwhere, 0, 0, 2)
	ZEND_ARG_INFO(0, expr)
	ZEND_ARG_INFO(0, values)
	ZEND_ARG_INFO(0, useOrWhere)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_mvc_model_query_builder_where_notinwhere, 0, 0, 2)
	ZEND_ARG_INFO(0, expr)
	ZEND_ARG_INFO(0, values)
	ZEND_ARG_INFO(0, useOrWhere)
ZEND_END_ARG_INFO()

static const zend_function_entry dao_mvc_model_query_builder_where_method_entry[] = {
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, setConditions, arginfo_dao_mvc_model_query_builder_where_setconditions, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, getConditions, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, where, arginfo_dao_mvc_model_query_builder_where_where, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, andWhere, arginfo_dao_mvc_model_query_builder_where_andwhere, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, orWhere, arginfo_dao_mvc_model_query_builder_where_orwhere, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, betweenWhere, arginfo_dao_mvc_model_query_builder_where_betweenwhere, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, notBetweenWhere, arginfo_dao_mvc_model_query_builder_where_notbetweenwhere, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, inWhere, arginfo_dao_mvc_model_query_builder_where_inwhere, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, notInWhere, arginfo_dao_mvc_model_query_builder_where_notinwhere, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Mvc_Model_Query_Builder_Where, getWhere, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
 ...
 */
DAO_INIT_CLASS(Dao_Mvc_Model_Query_Builder_Where){

	DAO_REGISTER_CLASS_EX(Dao\\Mvc\\Model\\Query\\Builder, Where, mvc_model_query_builder_where, dao_mvc_model_query_builder_ce, dao_mvc_model_query_builder_where_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_declare_property_null(dao_mvc_model_query_builder_where_ce, SL("_conditions"), ZEND_ACC_PROTECTED);

	zend_class_implements(dao_mvc_model_query_builder_where_ce, 1, dao_mvc_model_query_builderinterface_ce);
...
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, setConditions){
	...
	if (Z_TYPE_P(conditions) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(conditions), idx, str_key, single_condition_array) {
			...
			if (Z_TYPE_P(single_condition_array) == IS_ARRAY
				&& dao_array_isset_fetch_long(&condition_string, single_condition_array, 0, PH_READONLY)
				&& dao_array_isset_fetch_long(&tmp_bind_params, single_condition_array, 1, PH_READONLY)
				&& Z_TYPE(condition_string) == IS_STRING
				&& Z_TYPE(tmp_bind_params) == IS_ARRAY
			) {
				dao_array_update(&merged_conditions, &condition_string, &condition_string, PH_COPY);
				dao_array_merge_recursive_n(&merged_bind_params, &tmp_bind_params);

				if (dao_array_isset_fetch_long(&tmp_bind_types, single_condition_array, 2, PH_READONLY)
					&& Z_TYPE(tmp_bind_types) == IS_ARRAY) {
					dao_array_merge_recursive_n(&merged_bind_types, &tmp_bind_types);
				}
			} else if (Z_TYPE(single_condition_key) == IS_STRING) {
				DAO_CONCAT_VSVS(&condition_string, &single_condition_key, " = :", &single_condition_key, ":");

				dao_array_update(&merged_conditions, &single_condition_key, &condition_string, 0);

				if (Z_TYPE_P(single_condition_array) == IS_ARRAY) {
					dao_array_merge_recursive_n(&merged_bind_params, single_condition_array);
				} else {
					dao_array_update(&merged_bind_params, &single_condition_key, single_condition_array, PH_COPY);
				}
			}
		} ZEND_HASH_FOREACH_END();

		if (Z_TYPE_P(type) == IS_NULL || zend_is_true(type)) {
			dao_fast_join_str(&joind_condition, SL(" AND "), &merged_conditions);
		} else {
			dao_fast_join_str(&joind_condition, SL(" OR "), &merged_conditions);
		}
		zval_ptr_dtor(&merged_conditions);

		if (Z_TYPE_P(bind_params) == IS_ARRAY) {
			dao_array_merge_recursive_n(&merged_bind_params, bind_params);
		}
		if (Z_TYPE_P(bind_types) == IS_ARRAY) {
			dao_array_merge_recursive_n(&merged_bind_types, bind_types);
		}
	} else {
	...
	DAO_CALL_METHOD(NULL, getThis(), "setbindparams", &merged_bind_params, &merge);
	zval_ptr_dtor(&merged_bind_params);
	DAO_CALL_METHOD(NULL, getThis(), "setbindtypes", &merged_bind_types, &merge);
	...
	if (Z_TYPE_P(type) != IS_NULL) {
		...
		if (zend_is_true(type)) {
			...
			if (zend_is_true(&current_conditions)) {
				if (zend_is_true(grouping)) {
					DAO_CONCAT_SVSVS(&new_conditions, "(", &current_conditions, ") AND (", &joind_condition, ")");
				} else {
					DAO_CONCAT_VSV(&new_conditions, &current_conditions, " AND ", &joind_condition);
				}
			} else {
			...
			if (zend_is_true(&current_conditions)) {
				if (zend_is_true(grouping)) {
					DAO_CONCAT_SVSVS(&new_conditions, "(", &current_conditions, ") OR (", &joind_condition, ")");
				} else {
					DAO_CONCAT_VSV(&new_conditions, &current_conditions, " OR ", &joind_condition);
				}
			} else {
				ZVAL_COPY(&new_conditions, &joind_condition);
			}
		...
		dao_update_property(getThis(), SL("_conditions"), &joind_condition);
	}
...
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getConditions){
	...
	if (dao_is_numeric(&conditions)) {
		...
		if (Z_TYPE(models) == IS_ARRAY) {
			...
			DAO_MM_ADD_ENTRY(&number_models);
			is_smaller_function(&invalid_condition, &DAO_GLOBAL(z_one), &number_models);
			if (DAO_IS_TRUE(&invalid_condition)) {
				DAO_MM_THROW_EXCEPTION_STR(dao_mvc_model_query_exception_ce, "Cannot build the query. Invalid condition");
				return;
			}

			dao_array_fetch_long(&model, &models, 0, PH_NOISY|PH_READONLY);
		} else {
		...
		if (zend_is_true(&has)) {
			...
			object_init_ex(&meta_data, dao_mvc_model_metadata_memory_ce);
			DAO_MM_ADD_ENTRY(&meta_data);
		}

		ce0 = dao_fetch_class(&model, ZEND_FETCH_CLASS_DEFAULT);

		DAO_OBJECT_INIT(&model_instance, ce0);
		...
		if (dao_fast_count_ev(&primary_keys)) {
			if (dao_array_isset_fetch_long(&first_primary_key, &primary_keys, 0, PH_READONLY)) {
				...
				if (Z_TYPE(column_map) == IS_ARRAY) {
					if (!dao_array_isset_fetch(&attribute_field, &column_map, &first_primary_key, PH_COPY)) {
				...
				DAO_CONCAT_SVSVSV(return_value, "[", &model, "].[", &attribute_field, "] = ", &conditions);
				dao_update_property(getThis(), SL("_conditions"), return_value);
				RETURN_MM();
			}
		}
		 ...
		 */
		DAO_MM_THROW_EXCEPTION_STR(dao_mvc_model_query_exception_ce, "Source related to this model does not have a primary key defined");
		return;
	}
...
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, inWhere){
	...
	if (Z_TYPE_P(values) != IS_ARRAY) {
		DAO_THROW_EXCEPTION_STR(dao_mvc_model_query_exception_ce, "Values must be an array");
		return;
	}
...
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getPhql){
	...
	dao_read_property(return_value, getThis(), SL("_phql"), PH_NOISY|PH_COPY);
...
PHP_METHOD(Dao_Mvc_Model_Query_Builder_Where, getQuery){
	...
	if (zend_is_true(&has)) {;
		...
		DAO_MM_CALL_METHOD(&query, &dependency_injector, "get", &service_name, &args);
