 ...
 */
zend_class_entry *dao_aop_ce;

PHP_METHOD(Dao_Aop, addBefore);
PHP_METHOD(Dao_Aop, addAfter);
PHP_METHOD(Dao_Aop, addAfterReturning);
PHP_METHOD(Dao_Aop, addAfterThrowing);
PHP_METHOD(Dao_Aop, addAround);

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_aop_addbefore, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, pointcut, IS_STRING, 0)
	ZEND_ARG_CALLABLE_INFO(0, advice, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_aop_addafter, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, pointcut, IS_STRING, 0)
	ZEND_ARG_CALLABLE_INFO(0, advice, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_aop_addafterreturning, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, pointcut, IS_STRING, 0)
	ZEND_ARG_CALLABLE_INFO(0, advice, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_aop_addafterthrowing, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, pointcut, IS_STRING, 0)
	ZEND_ARG_CALLABLE_INFO(0, advice, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_aop_addaround, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, pointcut, IS_STRING, 0)
	ZEND_ARG_CALLABLE_INFO(0, advice, 0)
ZEND_END_ARG_INFO()

static const zend_function_entry dao_aop_method_entry[] = {
	PHP_ME(Dao_Aop, addBefore, arginfo_dao_aop_addbefore, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Aop, addAfter, arginfo_dao_aop_addafter, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Aop, addAfterReturning, arginfo_dao_aop_addafterreturning, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Aop, addAfterThrowing, arginfo_dao_aop_addafterthrowing, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Aop, addAround, arginfo_dao_aop_addaround, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_FE_END
};
...
DAO_INIT_CLASS(Dao_Aop){
	...
	DAO_REGISTER_CLASS(Dao, Aop, aop, dao_aop_method_entry, 0);

	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_BEFORE"),			DAO_AOP_KIND_BEFORE);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AFTER"),			DAO_AOP_KIND_AFTER);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AROUND"),			DAO_AOP_KIND_AROUND);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_PROPERTY"),		DAO_AOP_KIND_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_FUNCTION"),		DAO_AOP_KIND_FUNCTION);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_METHOD"),			DAO_AOP_KIND_METHOD);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_READ"),			DAO_AOP_KIND_READ);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_WRITE"),			DAO_AOP_KIND_WRITE);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AROUND_WRITE_PROPERTY"),		DAO_AOP_KIND_AROUND_WRITE_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AROUND_READ_PROPERTY"),		DAO_AOP_KIND_AROUND_READ_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_BEFORE_WRITE_PROPERTY"),		DAO_AOP_KIND_BEFORE_WRITE_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_BEFORE_READ_PROPERTY"),		DAO_AOP_KIND_BEFORE_READ_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AFTER_WRITE_PROPERTY"),		DAO_AOP_KIND_AFTER_WRITE_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AFTER_READ_PROPERTY"),		DAO_AOP_KIND_AFTER_READ_PROPERTY);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_BEFORE_METHOD"),		DAO_AOP_KIND_BEFORE_METHOD);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AFTER_METHOD"),		DAO_AOP_KIND_AFTER_METHOD);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AROUND_METHOD"),		DAO_AOP_KIND_AROUND_METHOD);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_BEFORE_FUNCTION"),	DAO_AOP_KIND_BEFORE_FUNCTION);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AFTER_FUNCTION"),		DAO_AOP_KIND_AFTER_FUNCTION);
	zend_declare_class_constant_long(dao_aop_ce, SL("KIND_AROUND_FUNCTION"),		DAO_AOP_KIND_AROUND_FUNCTION);
...
static int pointcut_match_zend_class_entry(dao_aop_pointcut *pc, zend_class_entry *ce) /*{{{*/
{
	int i, matches;
...
static zend_array *calculate_class_pointcuts(zend_class_entry *ce, int kind_of_advice) /*{{{*/
{
	...
	ZEND_HASH_FOREACH_VAL(DAO_GLOBAL(aop).pointcuts_table, pc_value) {
		pc = (dao_aop_pointcut *)Z_PTR_P(pc_value);

		if (!(pc->kind_of_advice & kind_of_advice)) {
			continue;
		}

		if ((ce == NULL && pc->kind_of_advice & DAO_AOP_KIND_FUNCTION)
...
static int pointcut_match_zend_function(dao_aop_pointcut *pc, zend_execute_data *ex) /*{{{*/
{
	int comp_start = 0;
...
static zend_array *calculate_function_pointcuts(zend_execute_data *ex) /*{{{*/
{
	...
	class_pointcuts = calculate_class_pointcuts(ce, DAO_AOP_KIND_FUNCTION | DAO_AOP_KIND_METHOD);
...
static int test_property_scope(dao_aop_pointcut *current_pc, zend_class_entry *ce, zend_string *member_str) /*{{{*/
{
...
dao_aop_object_cache *get_object_cache (zend_object *object) /*{{{*/
{
	int i;
	uint32_t handle;

	handle = object->handle;
	if (handle >= DAO_GLOBAL(aop).object_cache_size) {
		DAO_GLOBAL(aop).object_cache = erealloc(DAO_GLOBAL(aop).object_cache, sizeof(dao_aop_object_cache)*handle + 1);
		for (i = DAO_GLOBAL(aop).object_cache_size; i <= handle; i++) {
			DAO_GLOBAL(aop).object_cache[i] = NULL;
		}
		DAO_GLOBAL(aop).object_cache_size = handle+1;
	}
	if (DAO_GLOBAL(aop).object_cache[handle] == NULL) {
		DAO_GLOBAL(aop).object_cache[handle] = emalloc(sizeof(dao_aop_object_cache));
		DAO_GLOBAL(aop).object_cache[handle]->write = NULL;
		DAO_GLOBAL(aop).object_cache[handle]->read = NULL;
		DAO_GLOBAL(aop).object_cache[handle]->func = NULL;
	}
	return DAO_GLOBAL(aop).object_cache[handle];
}
/*}}}*/

/*{{{ get_object_cache_func/read/write*/
zend_array *get_object_cache_func(zend_object *object) {
	dao_aop_object_cache *cache;
	cache = get_object_cache(object);
	if (cache->func == NULL) {
		ALLOC_HASHTABLE(cache->func);
		zend_hash_init(cache->func, 16, NULL, dao_aop_free_pointcut_cache , 0);
	}
	return cache->func;
}
...
zend_array *get_object_cache_read(zend_object *object)
{
	...
	if (cache->read == NULL) {
		...
		zend_hash_init(cache->read, 16, NULL, dao_aop_free_pointcut_cache, 0);
	}
	return cache->read;
}
...
zend_array *get_object_cache_write(zend_object *object)
{
	...
	if (cache->write == NULL) {
		...
		zend_hash_init(cache->write, 16, NULL, dao_aop_free_pointcut_cache , 0);
	}
	return cache->write;
}
/*}}}*/
...
static zend_array *get_cache_func(zend_execute_data *ex) /*{{{*/
{
	...
	dao_aop_pointcut_cache *_pointcut_cache = NULL;
	...
	if (object == NULL) { //function or static method
		ht_object_cache = DAO_GLOBAL(aop).function_cache;
	...
	if (cache != NULL) {
		_pointcut_cache = (dao_aop_pointcut_cache *)Z_PTR_P(cache);
		if (_pointcut_cache->version != DAO_GLOBAL(aop).pointcut_version || (object != NULL && _pointcut_cache->ce != ce)) {
			//cache lost
	...
	if (_pointcut_cache == NULL) {
		_pointcut_cache = (dao_aop_pointcut_cache *)emalloc(sizeof(dao_aop_pointcut_cache));
		_pointcut_cache->ht = calculate_function_pointcuts(ex);
		_pointcut_cache->version = DAO_GLOBAL(aop).pointcut_version;
...
static zend_array *get_cache_property(zval *object, zval *member, int type) /*{{{*/
{
	...
	if (cache != NULL) {
		_pointcut_cache = (dao_aop_pointcut_cache *)Z_PTR_P(cache);
		if (_pointcut_cache->version != DAO_GLOBAL(aop).pointcut_version || _pointcut_cache->ce != Z_OBJCE_P(object)) {
			//cache lost
			_pointcut_cache = NULL;
...
static void execute_pointcut(dao_aop_pointcut *pc, zval *arg, zval *retval) /*{{{*/
{
	zval params[1];
...
void dao_aop_do_func_execute(HashPosition pos, zend_array *pointcut_table, zend_execute_data *ex, zval *aop_object) /*{{{*/
{
	dao_aop_pointcut *current_pc = NULL;
...
#endif
	dao_aop_joinpoint_object *joinpoint = dao_aop_joinpoint_object_from_obj(Z_OBJ_P(aop_object));
	...
	current_pc = (dao_aop_pointcut *)Z_PTR_P(current_pc_value);

	joinpoint->current_pointcut = current_pc;
	joinpoint->pos = pos;
	joinpoint->kind_of_advice = current_pc->kind_of_advice;

	if (current_pc->kind_of_advice & DAO_AOP_KIND_BEFORE) {
		if (!EG(exception)) {
	...
	if (current_pc->kind_of_advice & DAO_AOP_KIND_AROUND) {
		if (!EG(exception)) {
			execute_pointcut(current_pc, aop_object, &pointcut_ret);
			if (Z_TYPE(pointcut_ret) > IS_NULL) {
		...
		dao_aop_do_func_execute(pos, pointcut_table, ex, aop_object);
	}
	//DAO_AOP_KIND_AFTER
	if (current_pc->kind_of_advice & DAO_AOP_KIND_AFTER) {
		if (current_pc->kind_of_advice & DAO_AOP_KIND_CATCH && EG(exception)) {
		...
		} else if (current_pc->kind_of_advice & DAO_AOP_KIND_RETURN && !EG(exception)) {
			execute_pointcut(current_pc, aop_object, &pointcut_ret);
			if (Z_TYPE(pointcut_ret) > IS_NULL) {
				if (ex->return_value != NULL) {
					zval_ptr_dtor(ex->return_value);
...
void func_pointcut_and_execute(zend_execute_data *ex) /*{{{*/
{
	...
	object_init_ex(&aop_object, dao_aop_joinpoint_ce);
	joinpoint = dao_aop_joinpoint_object_from_obj(Z_OBJ(aop_object));
	joinpoint->ex = ex;
...
ZEND_API void dao_aop_execute_internal(zend_execute_data *ex, zval *return_value) /*{{{*/
{
	zend_function *fbc = NULL;

	fbc = ex->func;

	if (!DAO_GLOBAL(aop).enable_aop || fbc == NULL || DAO_GLOBAL(aop).overloaded || EG(exception) || fbc->common.function_name == NULL) {
		if (original_zend_execute_internal) {
...
//execute_ex overload
ZEND_API void dao_aop_execute_ex(zend_execute_data *ex) /*{{{*/
{
	zend_function *fbc = NULL;

	fbc = ex->func;

	if (!DAO_GLOBAL(aop).enable_aop || fbc == NULL || DAO_GLOBAL(aop).overloaded || EG(exception) || fbc->common.function_name == NULL || fbc->common.type == ZEND_EVAL_CODE || fbc->common.fn_flags & ZEND_ACC_CLOSURE) {
...
void dao_aop_do_read_property(HashPosition pos, zend_array *pointcut_table, zval *aop_object) /*{{{*/
{
	...
	joinpoint->current_pointcut = current_pc;
	joinpoint->pos = pos;
	joinpoint->kind_of_advice = (current_pc->kind_of_advice&DAO_AOP_KIND_WRITE) ? (current_pc->kind_of_advice - DAO_AOP_KIND_WRITE) : current_pc->kind_of_advice;
	...
	if (current_pc->kind_of_advice & DAO_AOP_KIND_AROUND) {
		execute_pointcut(current_pc, aop_object, &pointcut_ret);
		if (Z_TYPE(pointcut_ret) > IS_NULL) {
			ZVAL_COPY_VALUE(DAO_GLOBAL(aop).property_value, &pointcut_ret);
		} else if (joinpoint->return_value != NULL) {
			ZVAL_COPY(DAO_GLOBAL(aop).property_value, joinpoint->return_value);
		}
	} else {
		dao_aop_do_read_property(pos, pointcut_table, aop_object);
	}
...
zval *dao_aop_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv) /*{{{*/
{
	...
	if (DAO_GLOBAL(aop).lock_read_property > 25) {
	...
	if (DAO_GLOBAL(aop).property_value == NULL) {
		DAO_GLOBAL(aop).property_value = emalloc(sizeof(zval));
	}
	ZVAL_NULL(DAO_GLOBAL(aop).property_value);

	DAO_GLOBAL(aop).lock_read_property++;
	dao_aop_do_read_property(0, pointcut_table, &aop_object);
	DAO_GLOBAL(aop).lock_read_property--;

	zval_ptr_dtor(&aop_object);
	return DAO_GLOBAL(aop).property_value;
}
/*}}}*/
...
void dao_aop_do_write_property(HashPosition pos, zend_array *pointcut_table, zval *aop_object)
{
	...
	joinpoint->current_pointcut = current_pc;
	joinpoint->pos = pos;
	joinpoint->kind_of_advice = (current_pc->kind_of_advice&DAO_AOP_KIND_READ) ? (current_pc->kind_of_advice - DAO_AOP_KIND_READ) : current_pc->kind_of_advice;
	...
	if (current_pc->kind_of_advice & DAO_AOP_KIND_AROUND) {
		...
		dao_aop_do_write_property(pos, pointcut_table, aop_object);
	}
...
zval* dao_aop_write_property(zval *object, zval *member, zval *value, void **cache_slot)
{
	...
	dao_aop_do_write_property(0, pointcut_table, &aop_object);
	DAO_GLOBAL(aop).lock_write_property--;
...
static dao_aop_pointcut *dao_aop_alloc_pointcut() /*{{{*/
{
	dao_aop_pointcut *pc = (dao_aop_pointcut *)emalloc(sizeof(dao_aop_pointcut));
...
{
	dao_aop_pointcut *pc = (dao_aop_pointcut *)Z_PTR_P(elem);
...
{
	dao_aop_pointcut_cache *cache = (dao_aop_pointcut_cache *)Z_PTR_P(elem);
	if (cache->ht != NULL) {
...
static void dao_aop_add_pointcut (zend_fcall_info fci, zend_fcall_info_cache fci_cache, zend_string *selector, int cut_type) /*{{{*/
{
	zval pointcut_val;
	dao_aop_pointcut *pc = NULL;
	char *temp_str = NULL;
	int is_class = 0;
	scanner_state *state;
	scanner_token *token;
	...
	while(0 <= scan(state, token)) {
		...
		switch (token->TOKEN) {
			...
			case TOKEN_CLASS:
				...
				break;
			case TOKEN_PROPERTY:
				pc->kind_of_advice |= DAO_AOP_KIND_PROPERTY | token->int_val;
				break;
			case TOKEN_FUNCTION:
				if (is_class) {
					pc->kind_of_advice |= DAO_AOP_KIND_METHOD;
				} else {
					pc->kind_of_advice |= DAO_AOP_KIND_FUNCTION;
				}
				break;
			case TOKEN_TEXT:
				if (temp_str!=NULL) {
	...
	if (pc->kind_of_advice == cut_type) {
		pc->kind_of_advice |= DAO_AOP_KIND_READ | DAO_AOP_KIND_WRITE | DAO_AOP_KIND_PROPERTY;
	}

	dao_aop_make_regexp_on_pointcut(pc);

	ZVAL_PTR(&pointcut_val, pc);
	zend_hash_next_index_insert(DAO_GLOBAL(aop).pointcuts_table, &pointcut_val);
	DAO_GLOBAL(aop).pointcut_version++;
}
/*}}}*/
...
PHP_METHOD(Dao_Aop, addBefore){
	...
	if (!DAO_GLOBAL(aop).enable_aop) {
		DAO_THROW_EXCEPTION_STR(dao_aop_exception_ce, "Change dao.aop.enable_aop in php.ini.");
		return;
	}
	...
	ZEND_PARSE_PARAMETERS_END_EX(
		DAO_THROW_EXCEPTION_STR(dao_aop_exception_ce, "Expects a string for the pointcut as a first argument and a callback as a second argument");
		return;
	);
	...
	dao_aop_add_pointcut(fci, fci_cache, selector, DAO_AOP_KIND_BEFORE);
}
...
PHP_METHOD(Dao_Aop, addAfter){
	...
	dao_aop_add_pointcut(fci, fci_cache, selector, DAO_AOP_KIND_AFTER | DAO_AOP_KIND_CATCH | DAO_AOP_KIND_RETURN);
}
...
PHP_METHOD(Dao_Aop, addAfterReturning){
	...
	dao_aop_add_pointcut(fci, fci_cache, selector, DAO_AOP_KIND_AFTER | DAO_AOP_KIND_RETURN);
}
...
PHP_METHOD(Dao_Aop, addAfterThrowing){
	...
	dao_aop_add_pointcut(fci, fci_cache, selector, DAO_AOP_KIND_AFTER | DAO_AOP_KIND_CATCH);
}
...
PHP_METHOD(Dao_Aop, addAround){
	...
	dao_aop_add_pointcut(fci, fci_cache, selector, DAO_AOP_KIND_AROUND);
}
