 ...
 *
 */
zend_class_entry *dao_py_ce;

PHP_METHOD(Dao_Py, import);
PHP_METHOD(Dao_Py, construct);
PHP_METHOD(Dao_Py, callFunction);
PHP_METHOD(Dao_Py, callMethod);
PHP_METHOD(Dao_Py, eval);
PHP_METHOD(Dao_Py, exec);
PHP_METHOD(Dao_Py, list);
PHP_METHOD(Dao_Py, tuple);
PHP_METHOD(Dao_Py, dict);
PHP_METHOD(Dao_Py, val);
PHP_METHOD(Dao_Py, version);

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_import, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_construct, 0, 0, 2)
	ZEND_ARG_INFO(0, moduleName)
	ZEND_ARG_TYPE_INFO(0, className, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_callfunction, 0, 0, 2)
	ZEND_ARG_INFO(0, moduleName)
	ZEND_ARG_TYPE_INFO(0, functionName, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_callmethod, 0, 0, 2)
	ZEND_ARG_OBJ_INFO(0, object, Dao\\Py\\Object, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, args, IS_ARRAY, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_eval, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, expr, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_exec, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, command, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_list, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, val, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_tuple, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, val, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_dict, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, val, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_val, 0, 0, 1)
	ZEND_ARG_INFO(0, val)
ZEND_END_ARG_INFO()

static const zend_function_entry dao_py_method_entry[] = {
	PHP_ME(Dao_Py, import, arginfo_dao_py_import, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, construct, arginfo_dao_py_construct, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, callFunction, arginfo_dao_py_callfunction, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, callMethod, arginfo_dao_py_callmethod, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, eval, arginfo_dao_py_eval, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, exec, arginfo_dao_py_exec, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, list, arginfo_dao_py_list, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, tuple, arginfo_dao_py_tuple, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, dict, arginfo_dao_py_dict, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, val, arginfo_dao_py_val, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py, version, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_FE_END
};
 ...
 * Dao\Py initializer
 */
DAO_INIT_CLASS(Dao_Py){

	DAO_REGISTER_CLASS(Dao, Py, py, dao_py_method_entry, 0);
...
PHP_METHOD(Dao_Py, import){
	...
	if (!modulename) {
		DAO_THROW_EXCEPTION_FORMAT(dao_py_exception_ce, "Could't create string %s!", Z_STRVAL_P(name));		
	...
	if (!module) {
		DAO_THROW_EXCEPTION_FORMAT(dao_py_exception_ce, "Error import module %s!", Z_STRVAL_P(name));		
		PHP_PYTHON_THREAD_RELEASE();
		return;
	}
...
PHP_METHOD(Dao_Py, construct){
	...
	dao_py_object_object* intern;
	PyObject *module;

	dao_fetch_params(0, 2, 0, &module_name, &class_name);

	PHP_PYTHON_THREAD_ACQUIRE();

	if (Z_TYPE_P(module_name) == IS_OBJECT && dao_instance_of_ev(module_name, dao_py_object_ce)) {
		intern = dao_py_object_object_from_obj(Z_OBJ_P(module_name));
		module = intern->obj;
		Py_INCREF(module);
	} else if (Z_TYPE_P(module_name) == IS_STRING) {
		module = PyImport_ImportModule(Z_STRVAL_P(module_name));
	} else {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "The module paramerter must be string or Dao\\Py\\Object");
		PHP_PYTHON_THREAD_RELEASE();
		return;
	}
	...
	if (module) {
		...
		if (class && PyCallable_Check(class)) {
			dao_py_object_object *object_intern;
			...
			object_init_ex(return_value, dao_py_object_ce);
			object_intern = dao_py_object_object_from_obj(Z_OBJ_P(return_value));
...
PHP_METHOD(Dao_Py, callFunction){
	...
	dao_fetch_params(0, 2, 0, &module_name, &function_name);
...
PHP_METHOD(Dao_Py, callMethod){
	...
	dao_fetch_params(0, 2, 0, &object, &name);

	PHP_PYTHON_THREAD_ACQUIRE();

	intern = dao_py_object_object_from_obj(Z_OBJ_P(object));
	methodname = PyString_FromString(Z_STRVAL_P(name));

    if (intern->obj == NULL) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Object error");
		return;
    }
