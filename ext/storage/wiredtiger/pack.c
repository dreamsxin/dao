...
static int dao_storage_wiredtiger_pack_key_scalar(dao_storage_wiredtiger_cursor_object *intern, dao_storage_wiredtiger_pack_item *item, zval *key)
{
	int ret;
	const char *format;
	size_t format_len;
...
static int dao_storage_wiredtiger_pack_key_array(dao_storage_wiredtiger_cursor_object *intern, dao_storage_wiredtiger_pack_item *item, zval *key)
{
	int ret;
	const char *format;
	size_t i, format_len;
...
int dao_storage_wiredtiger_pack_key(dao_storage_wiredtiger_cursor_object *intern, dao_storage_wiredtiger_pack_item *item, zval *key)
{
	if (Z_TYPE_P(key) == IS_ARRAY) {
		return dao_storage_wiredtiger_pack_key_array(intern, item, key);
	} else {
		return dao_storage_wiredtiger_pack_key_scalar(intern, item, key);
	}
}

static int dao_storage_wiredtiger_pack_value_scalar(dao_storage_wiredtiger_cursor_object *intern, dao_storage_wiredtiger_pack_item *item, zval *value)
{
	int ret;
	const char *format;
	size_t format_len;
...
static int dao_storage_wiredtiger_pack_value_array(dao_storage_wiredtiger_cursor_object *intern, dao_storage_wiredtiger_pack_item *item, zval *value)
{
	int ret;
	const char *format;
	size_t i, format_len;
...
int dao_storage_wiredtiger_pack_value(dao_storage_wiredtiger_cursor_object *intern, dao_storage_wiredtiger_pack_item *item, zval *value)
{
	if (Z_TYPE_P(value) == IS_ARRAY) {
		return dao_storage_wiredtiger_pack_value_array(intern, item, value);
	} else {
		return dao_storage_wiredtiger_pack_value_scalar(intern, item, value);
	}
}

static int dao_storage_wiredtiger_unpack_ex(dao_storage_wiredtiger_cursor_object *intern, zval *return_value, const char *format, WT_ITEM *item)
{
	int ret;
...
{
	return dao_storage_wiredtiger_unpack_ex(intern, return_value, intern->cursor->key_format, item);
}

int dao_storage_wiredtiger_unpack_value(dao_storage_wiredtiger_cursor_object *intern, zval *return_value, WT_ITEM *item)
{
	return dao_storage_wiredtiger_unpack_ex(intern, return_value, intern->cursor->value_format, item);
}
