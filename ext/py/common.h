...
#ifndef DAO_PY_COMMON_H
#define DAO_PY_COMMON_H
...
#define PHP_PYTHON_THREAD_ASSERT() assert(PyThreadState_GET() == DAO_GLOBAL(python).tstate)
#define PHP_PYTHON_THREAD_ACQUIRE() PyEval_AcquireThread(DAO_GLOBAL(python).tstate)
