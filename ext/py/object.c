 ...
 *
 */
zend_class_entry *dao_py_object_ce;

PHP_METHOD(Dao_Py_Object, __construct);

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_object___construct, 0, 0, 2)
	ZEND_ARG_OBJ_INFO(0, moduleName, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, className, IS_STRING, 0)
ZEND_END_ARG_INFO()

static const zend_function_entry dao_py_object_method_entry[] = {
	PHP_ME(Dao_Py_Object, __construct, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_FE_END
};

zend_object_handlers dao_py_object_object_handlers;
zend_object* dao_py_object_object_create_handler(zend_class_entry *ce)
{
	dao_py_object_object *intern = ecalloc(1, sizeof(dao_py_object_object) + zend_object_properties_size(ce));
	intern->std.ce = ce;

	zend_object_std_init(&intern->std, ce);
	object_properties_init(&intern->std, ce);
	intern->std.handlers = &dao_py_object_object_handlers;

	return &intern->std;
}

void dao_py_object_object_free_handler(zend_object *object)
{
	dao_py_object_object *intern;

	intern = dao_py_object_object_from_obj(object);
...
{
	dao_py_object_object *pip = dao_py_object_object_from_obj(object);
...
{
	dao_py_object_object *pip = dao_py_object_object_from_obj(Z_OBJ_P(object));
	return pip->std.ce->constructor;
}
*/
static zend_string* python_get_class_name(const zend_object *object)
{
	dao_py_object_object *pip = dao_py_object_object_from_obj((zend_object*)object);
...
{
	dao_py_object_object *a = dao_py_object_object_from_obj(object1);
	dao_py_object_object *b = dao_py_object_object_from_obj(object2);
	int cmp;
...
{
	dao_py_object_object *pip = dao_py_object_object_from_obj(readobj);
	PyObject *val = NULL;
	int ret = FAILURE;
...
{
	dao_py_object_object *a = dao_py_object_object_from_obj(Z_OBJ_P(object1));
	dao_py_object_object *b = dao_py_object_object_from_obj(Z_OBJ_P(object2));
	int cmp;
...
{
	dao_py_object_object *pip = dao_py_object_object_from_obj(Z_OBJ_P(readobj));
	PyObject *val = NULL;
	int ret = FAILURE;
...
/**
 * Dao\Py\Object initializer
 */
DAO_INIT_CLASS(Dao_Py_Object){

	DAO_REGISTER_CLASS_CREATE_OBJECT(Dao\\Py, Object, py_object, dao_py_object_method_entry, 0);

	dao_py_object_object_handlers.read_property = python_read_property;
	dao_py_object_object_handlers.write_property = python_write_property;
	dao_py_object_object_handlers.read_dimension = python_read_dimension;
	dao_py_object_object_handlers.write_dimension = python_write_dimension;
	dao_py_object_object_handlers.has_property = python_has_property;
	dao_py_object_object_handlers.unset_property = python_unset_property;
	dao_py_object_object_handlers.has_dimension = python_has_dimension;
	dao_py_object_object_handlers.unset_dimension = python_unset_dimension;
	dao_py_object_object_handlers.get_properties = python_get_properties;
	dao_py_object_object_handlers.get_method = python_get_method;
	dao_py_object_object_handlers.call_method = python_call_method;
	//dao_py_object_object_handlers.get_constructor = python_constructor_get;
	dao_py_object_object_handlers.get_class_name = python_get_class_name;
	dao_py_object_object_handlers.compare_objects = python_compare;
	dao_py_object_object_handlers.cast_object = python_cast;
	dao_py_object_object_handlers.count_elements = python_count_elements;

	return SUCCESS;
}

/**
 * Dao\Py\Object constructor
 *
 */
PHP_METHOD(Dao_Py_Object, __construct)
{
	...
	object_intern = dao_py_object_object_from_obj(Z_OBJ_P(getThis()));
