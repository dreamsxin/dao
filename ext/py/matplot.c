 ...
 *
 */
zend_class_entry *dao_py_matplot_ce;

PHP_METHOD(Dao_Py_Matplot, factory);
PHP_METHOD(Dao_Py_Matplot, __construct);
PHP_METHOD(Dao_Py_Matplot, annotate);
PHP_METHOD(Dao_Py_Matplot, plot);
PHP_METHOD(Dao_Py_Matplot, fillBetween);
PHP_METHOD(Dao_Py_Matplot, hist);
PHP_METHOD(Dao_Py_Matplot, errorbar);
PHP_METHOD(Dao_Py_Matplot, figure);
PHP_METHOD(Dao_Py_Matplot, legend);
PHP_METHOD(Dao_Py_Matplot, ylim);
PHP_METHOD(Dao_Py_Matplot, getYlim);
PHP_METHOD(Dao_Py_Matplot, xlim);
PHP_METHOD(Dao_Py_Matplot, getXlim);
PHP_METHOD(Dao_Py_Matplot, subplot);
PHP_METHOD(Dao_Py_Matplot, title);
PHP_METHOD(Dao_Py_Matplot, axis);
PHP_METHOD(Dao_Py_Matplot, xlabel);
PHP_METHOD(Dao_Py_Matplot, ylabel);
PHP_METHOD(Dao_Py_Matplot, grid);
PHP_METHOD(Dao_Py_Matplot, show);
PHP_METHOD(Dao_Py_Matplot, close);
PHP_METHOD(Dao_Py_Matplot, draw);
PHP_METHOD(Dao_Py_Matplot, pause);
PHP_METHOD(Dao_Py_Matplot, save);
PHP_METHOD(Dao_Py_Matplot, clf);
PHP_METHOD(Dao_Py_Matplot, tightLayout);
PHP_METHOD(Dao_Py_Matplot, __call);

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_factory, 0, 0, 0)
	ZEND_ARG_TYPE_INFO(0, backend, IS_STRING, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot___construct, 0, 0, 0)
	ZEND_ARG_TYPE_INFO(0, backend, IS_STRING, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_annotate, 0, 0, 3)
	ZEND_ARG_TYPE_INFO(0, annotation, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, x, IS_DOUBLE, 0)
	ZEND_ARG_TYPE_INFO(0, y, IS_DOUBLE, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_plot, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_fillbetween, 0, 0, 4)
	ZEND_ARG_TYPE_INFO(0, x, IS_ARRAY, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_hist, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_errorbar, 0, 0, 3)
	ZEND_ARG_TYPE_INFO(0, x, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, y, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, yerr, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_ylim, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, left, IS_DOUBLE, 0)
	ZEND_ARG_TYPE_INFO(0, right, IS_DOUBLE, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_xlim, 0, 0, 2)
	ZEND_ARG_TYPE_INFO(0, left, IS_DOUBLE, 0)
	ZEND_ARG_TYPE_INFO(0, right, IS_DOUBLE, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_title, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, title, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_axis, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, axis, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_xlabel, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, xlabel, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_ylabel, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, ylabel, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_grid, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, flag, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_pause, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, interval, IS_DOUBLE, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot_save, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_dao_py_matplot___call, 0, 0, 1)
	ZEND_ARG_INFO(0, method)
	ZEND_ARG_INFO(0, arguments)
ZEND_END_ARG_INFO()

static const zend_function_entry dao_py_matplot_method_entry[] = {
	PHP_ME(Dao_Py_Matplot, factory, arginfo_dao_py_matplot_factory, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Dao_Py_Matplot, __construct, arginfo_dao_py_matplot___construct, ZEND_ACC_PRIVATE|ZEND_ACC_CTOR)
	PHP_ME(Dao_Py_Matplot, annotate, arginfo_dao_py_matplot_annotate, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, plot, arginfo_dao_py_matplot_plot, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, fillBetween, arginfo_dao_py_matplot_fillbetween, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, hist, arginfo_dao_py_matplot_hist, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, errorbar, arginfo_dao_py_matplot_errorbar, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, figure, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, legend, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, ylim, arginfo_dao_py_matplot_ylim, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, getYlim, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, xlim, arginfo_dao_py_matplot_xlim, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, getXlim, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, subplot, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, title, arginfo_dao_py_matplot_title, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, axis, arginfo_dao_py_matplot_axis, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, xlabel, arginfo_dao_py_matplot_xlabel, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, ylabel, arginfo_dao_py_matplot_ylabel, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, grid, arginfo_dao_py_matplot_grid, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, show, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, close, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, draw, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, pause, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, save, arginfo_dao_py_matplot_save, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, clf, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, tightLayout, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Dao_Py_Matplot, __call, arginfo_dao_py_matplot___call, ZEND_ACC_PUBLIC)
	PHP_FE_END
};

zend_object_handlers dao_py_matplot_object_handlers;
zend_object* dao_py_matplot_object_create_handler(zend_class_entry *ce)
{
	dao_py_matplot_object *intern = ecalloc(1, sizeof(dao_py_matplot_object) + zend_object_properties_size(ce));
	intern->std.ce = ce;

	zend_object_std_init(&intern->std, ce);
	object_properties_init(&intern->std, ce);
	intern->std.handlers = &dao_py_matplot_object_handlers;

	return &intern->std;
}

void dao_py_matplot_object_free_handler(zend_object *object)
{
	zend_object_std_dtor(object);
}

/**
 * Dao\Py\Matplot initializer
 */
DAO_INIT_CLASS(Dao_Py_Matplot){

	DAO_REGISTER_CLASS_CREATE_OBJECT(Dao\\Py, Matplot, py_matplot, dao_py_matplot_method_entry, 0);

	zend_declare_property_null(dao_py_matplot_ce, SL("_instance"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC);
...
/**
 *
 * @return Dao\Py\Matplot
 **/
PHP_METHOD(Dao_Py_Matplot, factory)
{
	zval *backend = NULL, instance = {};

	dao_fetch_params(0, 0, 1, &backend);

	if (!backend) {
		backend = &DAO_GLOBAL(z_null);
	}

	dao_read_static_property_ce(&instance, dao_py_matplot_ce, SL("_instance"), PH_READONLY);
	if (Z_TYPE(instance) == IS_NULL) {
		object_init_ex(return_value, dao_py_matplot_ce);
		DAO_CALL_METHOD(NULL, return_value, "__construct", backend);

		dao_update_static_property_ce(dao_py_matplot_ce, SL("_instance"), return_value);
	} else {
...
/**
 * Dao\Py\Matplot constructor
 *
 */
PHP_METHOD(Dao_Py_Matplot, __construct)
{
	zval *backend = NULL;
	dao_py_matplot_object *intern;

	dao_fetch_params(0, 0, 1, &backend);

	intern = dao_py_matplot_object_from_obj(Z_OBJ_P(getThis()));

	PHP_PYTHON_THREAD_ACQUIRE();

	intern->matplotlib = PyImport_ImportModule("matplotlib");
	if (!intern->matplotlib) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Error loading module matplotlib!");		
	...
	if (!intern->pyplot) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Error loading module matplotlib.pyplot!");		
		PHP_PYTHON_THREAD_RELEASE();
		return;
	}
	...
	if (!intern->pylab) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Error loading module pylab!");		
		PHP_PYTHON_THREAD_RELEASE();
		return;
	}
	...
	if(!intern->s_python_function_show
		...
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Couldn't find required function!");		
		PHP_PYTHON_THREAD_RELEASE();
		return;
	}
	...
	if (!PyFunction_Check(intern->s_python_function_show)
		...
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Python object is unexpectedly not a PyFunction!");		
		PHP_PYTHON_THREAD_RELEASE();
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, annotate){
	...
	dao_fetch_params(0, 3, 0, &annotation, &x, &y);
...
PHP_METHOD(Dao_Py_Matplot, plot){
	...
	dao_fetch_params(0, 1, 4, &_x, &_y, &format, &style, &label);
...
PHP_METHOD(Dao_Py_Matplot, fillBetween){
	...
	dao_fetch_params(0, 4, 0, &x, &y1, &y2, &keywords);
...
PHP_METHOD(Dao_Py_Matplot, hist){
	...
	dao_fetch_params(0, 1, 4, &y, &bins, &color, &alpha, &label);
...
PHP_METHOD(Dao_Py_Matplot, errorbar){
	...
	dao_fetch_params(0, 3, 0, &x, &y, &yerr);
	...
	if (res) {
		...
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to errorbar() failed.");		
		PHP_PYTHON_THREAD_RELEASE();
	}
...
PHP_METHOD(Dao_Py_Matplot, figure){
	...
	if(!res) {		
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to figure() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, legend){
	...
	if(!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to legend() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, ylim){
	...
	dao_fetch_params(0, 2, 0, &left, &right);
	...
	if(!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to ylim() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, getYlim){
	...
	if(!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to getylim() failed.");
		return;
	}
	...
	dao_array_append_double(return_value, PyFloat_AsDouble(left));
	dao_array_append_double(return_value, PyFloat_AsDouble(right));
...
PHP_METHOD(Dao_Py_Matplot, xlim){
	...
	if(!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to xlim() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, getXlim){
	...
	if(!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to getxlim() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, subplot){
	...
	dao_fetch_params(0, 3, 0, &nrows, &ncols, &plot_number);
	...
	if(!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to subplot() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, title){
	...
	Py_DECREF(args);
	if (!res) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to title() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, axis){
	...
	if (!res) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to axis() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, xlabel){
	...
	if (!res) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to xlabel() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, ylabel){
	...
	if (!res) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to ylabel() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, grid){
	...
	Py_DECREF(args);
	if (!res) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to grid() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, show){
	...
	if (!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to show() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, close){
	...
	if (!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to close() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, draw){
	...
	if (!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to draw() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, pause){
	...
	if (!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to pause() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, save){
	...
	Py_DECREF(args);
	if (!res) {
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to save() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, clf){
	...
	if (!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to clf() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, tightLayout){
	...
	if (!res) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_STR(dao_py_exception_ce, "Call to tightLayout() failed.");
		return;
	}
...
PHP_METHOD(Dao_Py_Matplot, __call){
	...
	if (!arguments) {
		...
		zval zero = {};
		if (dao_array_isset_fetch_long(&zero, arguments, 0, PH_READONLY) && Z_TYPE(zero) == IS_ARRAY) {
			zval _args = {}, _kwargs = {};
			if (dao_array_isset_fetch_str(&_args, &zero, SL("args"), PH_READONLY)) {
				args = pip_hash_to_tuple(&_args);
			} else {
				args = PyTuple_New(0);
			}
			if (dao_array_isset_fetch_str(&_kwargs, &zero, SL("kwargs"), PH_READONLY)) {
	...
	if (!retval) {
		PHP_PYTHON_THREAD_RELEASE();
		DAO_THROW_EXCEPTION_FORMAT(dao_py_exception_ce, "Call to %s() failed.", Z_STRVAL_P(method));
		return;
	}
