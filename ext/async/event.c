...
void async_event_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "PollEvent", poll_event_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "TickEvent", tick_event_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "TimerEvent", timer_event_functions);
