...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_with, 0, 2, Dao\\Async\\Context, 0)
	ZEND_ARG_OBJ_INFO(0, var, Dao\\Async\\ContextVar, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_setvar, 0, 2, Dao\\Async\\Context, 0)
...
static PHP_METHOD(Context, setVar)
{
	...
	if (current->var == NULL) {
		...
		DAO_CALL_METHOD(NULL, &key, "__construct", name);
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_with_isolated_output, 0, 0, Dao\\Async\\Context, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_with_timeout, 0, 1, Dao\\Async\\Context, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_with_cancel, 0, 1, Dao\\Async\\Context, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_shield, 0, 0, Dao\\Async\\Context, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_current, 0, 0, Dao\\Async\\Context, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_context_background, 0, 0, Dao\\Async\\Context, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_context_var_get, 0, 0, 0)
	ZEND_ARG_OBJ_INFO(0, context, Dao\\Async\\Context, 1)
ZEND_END_ARG_INFO();
...
void async_context_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Context", async_context_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "ContextVar", async_context_var_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "CancellationHandler", async_cancellation_handler_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "CancellationException", empty_funcs);
