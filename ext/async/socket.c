...
void async_socket_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "Socket", async_socket_functions);
	async_socket_ce = zend_register_internal_interface(&ce);
	
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketStream", async_socket_stream_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "Server", async_server_functions);
	async_server_ce = zend_register_internal_interface(&ce);

	zend_class_implements(async_server_ce, 1, async_socket_ce);

	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketAcceptException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketBindException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketConnectException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketDisconnectException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "SocketListenException", empty_funcs);
