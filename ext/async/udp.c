...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_socket_bind, 0, 0, Dao\\Async\\Network\\UdpSocket, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_socket_connect, 0, 2, Dao\\Async\\Network\\UdpSocket, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_socket_multicast, 0, 2, Dao\\Async\\Network\\UdpSocket, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_socket_receive, 0, 0, Dao\\Async\\Network\\UdpDatagram, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_udp_socket_send, 0, 1, IS_VOID, 0)
	ZEND_ARG_OBJ_INFO(0, datagram, Dao\\Async\\Network\\UdpDatagram, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_datagram_with_data, 0, 1, Dao\\Async\\Network\\UdpDatagram, 0)
	ZEND_ARG_TYPE_INFO(0, data, IS_STRING, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_datagram_with_peer, 0, 2, Dao\\Async\\Network\\UdpDatagram, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_udp_datagram_without_peer, 0, 0, Dao\\Async\\Network\\UdpDatagram, 0)
ZEND_END_ARG_INFO();
...
void async_udp_socket_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "UdpSocket", async_udp_socket_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Network", "UdpDatagram", async_udp_datagram_functions);
