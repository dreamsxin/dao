...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_connect, 0, 0, Dao\\Async\\Network\\Pipe, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_get_stdin, 0, 0, Dao\\Async\\Stream\\WritableStream, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_get_stdout, 0, 0, Dao\\Async\\Stream\\ReadableStream, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_get_stderr, 0, 0, Dao\\Async\\Stream\\ReadableStream, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_get_ipc, 0, 0, Dao\\Async\\Network\\Pipe, 0)
ZEND_END_ARG_INFO();
...
void async_process_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Process", "Process", async_process_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Process", "ReadablePipe", async_readable_process_pipe_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Process", "WritablePipe", async_writable_process_pipe_functions);
