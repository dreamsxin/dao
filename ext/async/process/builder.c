...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_fork, 0, 1, Dao\\Async\\Process\\ProcessBuilder, 0)
...
static PHP_METHOD(ProcessBuilder, fork)
{
	...
	ZVAL_STRING(&builder->argv[i++], "-ddao.async.forked=1");
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_shell, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_cwd, 0, 1, Dao\\Async\\Process\\ProcessBuilder, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_env, 0, 1, Dao\\Async\\Process\\ProcessBuilder, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_stdin_pipe, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_stdin_inherited, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_without_stdin, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_stdout_pipe, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_stdout_inherited, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, fd, IS_LONG, 1)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_without_stdout, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_stderr_pipe, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_with_stderr_inherited, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, fd, IS_LONG, 1)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_without_stderr, 0, 0, Dao\\Async\\Process\\ProcessBuilder, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_process_builder_start, 0, 0, Dao\\Async\\Process\\Process, 0)
	ZEND_ARG_VARIADIC_TYPE_INFO(0, arguments, IS_STRING, 0)
ZEND_END_ARG_INFO();
...
void async_process_builder_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Process", "ProcessBuilder", async_process_builder_functions);
