...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_task_async, 0, 1, Dao\\Async\\Awaitable, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_task_async_with_context, 0, 2, Dao\\Async\\Awaitable, 0)
	ZEND_ARG_OBJ_INFO(0, context, Dao\\Async\\Context, 0)
	ZEND_ARG_CALLABLE_INFO(0, callback, 0)
	ZEND_ARG_VARIADIC_INFO(0, arguments)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_task_await, 0, 0, 1)
	ZEND_ARG_OBJ_INFO(0, awaitable, Dao\\Async\\Awaitable, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_task_scheduler_tick, 0, 1, Dao\\Async\\TickEvent, 0)
	ZEND_ARG_CALLABLE_INFO(0, callback, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_task_scheduler_timer, 0, 1, Dao\\Async\\TimerEvent, 0)
	ZEND_ARG_CALLABLE_INFO(0, callback, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_task_scheduler_poll, 0, 2, Dao\\Async\\PollEvent, 0)
...
void async_task_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Awaitable", empty_funcs);
	async_awaitable_ce = zend_register_internal_interface(&ce);
	async_awaitable_ce->interface_gets_implemented = implements_awaitable;

	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Component", async_component_functions);
	async_component_ce = zend_register_internal_interface(&ce);

	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "AwaitableImpl", empty_funcs);
