...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_readable_console_stream_get_stdin, 0, 0, Dao\\Async\\Stream\\ReadablePipe, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_writable_console_stream_get_stdout, 0, 0, Dao\\Async\\Stream\\WritablePipe, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_writable_console_stream_get_stderr, 0, 0, Dao\\Async\\Stream\\WritablePipe, 0)
ZEND_END_ARG_INFO();
...
void async_console_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "ReadablePipe", async_readable_pipe_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "WritablePipe", async_writable_pipe_functions);
