...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_timer_timeout, 0, 1, Dao\\Async\\Awaitable, 0)
	ZEND_ARG_TYPE_INFO(0, milliseconds, IS_LONG, 0)
ZEND_END_ARG_INFO();
...
void async_timer_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Timer", async_timer_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Timeout", async_timeout_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "TimeoutException", empty_funcs);
