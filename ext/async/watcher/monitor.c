...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_monitor_await_event, 0, 0, Dao\\Async\\MonitorEvent, 0)
ZEND_END_ARG_INFO();
...
void async_monitor_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Monitor", async_monitor_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "MonitorEvent", async_monitor_event_functions);
