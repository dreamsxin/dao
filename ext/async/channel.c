...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_channel_group_select, 0, 0, Dao\\Async\\ChannelSelect, 1)
	ZEND_ARG_TYPE_INFO(0, timeout, IS_LONG, 1)
ZEND_END_ARG_INFO();
...
void async_channel_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Channel", channel_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "ChannelGroup", channel_group_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "ChannelIterator", channel_iterator_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "ChannelSelect", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "ChannelClosedException", empty_funcs);
