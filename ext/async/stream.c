...
void async_stream_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "ReadableStream", async_readable_stream_functions);
	async_readable_stream_ce = zend_register_internal_interface(&ce);

	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "WritableStream", async_writable_stream_functions);
	async_writable_stream_ce = zend_register_internal_interface(&ce);

	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "DuplexStream", async_duplex_stream_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "StreamException", empty_funcs);
	async_stream_exception_ce = zend_register_internal_class(&ce);

	zend_do_inheritance(async_stream_exception_ce, zend_ce_exception);

	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "StreamClosedException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "PendingReadException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "ReadableMemoryStream", async_readable_memory_stream_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "WritableMemoryStream", async_writable_memory_stream_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "StreamReader", async_stream_reader_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async\\Stream", "StreamWriter", async_stream_writer_functions);
