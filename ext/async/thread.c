...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_thread_connect, 0, 0, Dao\\Async\\Network\\Pipe, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_thread_get_ipc, 0, 0, Dao\\Async\\Network\\Pipe, 0)
ZEND_END_ARG_INFO();
...
void async_thread_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Thread", thread_functions);
