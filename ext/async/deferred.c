...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_deferred_awaitable, 0, 0, Dao\\Async\\Awaitable, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_deferred_value, 0, 0, Dao\\Async\\Awaitable, 0)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_deferred_error, 0, 1, Dao\\Async\\Awaitable, 0)
	ZEND_ARG_OBJ_INFO(0, error, Throwable, 0)
ZEND_END_ARG_INFO();
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_deferred_combine, 0, 2, Dao\\Async\\Awaitable, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_deferred_transform, 0, 2, Dao\\Async\\Awaitable, 0)
...
void async_deferred_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "Deferred", deferred_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Dao\\Async", "DeferredAwaitable", deferred_awaitable_functions);
