...
namespace Dao\Mvc {
	...
	class View extends \Dao\Di\Injectable implements \Dao\Events\EventsAwareInterface, \Dao\Di\InjectionAwareInterface, \Dao\Mvc\ViewInterface {
		...
		protected $_enableMultiNamespaceView;
		 ...
		 * @return \Dao\Mvc\View
		 */
		public function enableMultiNamespaceView(){ }
		 ...
		 * @return \Dao\Mvc\View
		 */
		public function disableMultiNamespaceView(){ }
