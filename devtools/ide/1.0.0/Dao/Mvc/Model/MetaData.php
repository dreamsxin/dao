...
namespace Dao\Mvc\Model {
	...
	abstract class MetaData extends \Dao\Di\Injectable implements \Dao\Events\EventsAwareInterface, \Dao\Di\InjectionAwareInterface, \Dao\Mvc\Model\MetaDataInterface {
		 ...
		 * @return string
		 */
		public function getCacheKey($model, $table, $schema){ }
