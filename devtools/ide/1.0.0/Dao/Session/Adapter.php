...
namespace Dao\Session {
	...
	abstract class Adapter extends \Dao\Di\Injectable implements \Dao\Events\EventsAwareInterface, \Dao\Di\InjectionAwareInterface, \Dao\Session\AdapterInterface, \Countable, \IteratorAggregate, \Traversable, \ArrayAccess {
		 ...
		 * @return boolean
		 */
		public function regenerate($delete_old_session=null){ }
