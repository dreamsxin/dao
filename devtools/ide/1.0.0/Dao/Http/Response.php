...
namespace Dao\Http {
	...
	class Response extends \Dao\Di\Injectable implements \Dao\Events\EventsAwareInterface, \Dao\Di\InjectionAwareInterface, \Dao\Http\ResponseInterface {
		...
		*</code>
		 ...
		 * @return string
		 */
		public function getBsonContent(){ }
