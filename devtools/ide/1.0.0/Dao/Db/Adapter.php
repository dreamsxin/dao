...
namespace Dao\Db {
	...
	abstract class Adapter extends \Dao\Di\Injectable implements \Dao\Events\EventsAwareInterface, \Dao\Di\InjectionAwareInterface, \Dao\Db\AdapterInterface {
		 ...
		 */
		public function createSelectBuilder($tables){ }
		 ...
		 */
		public function createUpdateBuilder($table){ }
		 ...
		 */
		public function createInsertBuilder($table){ }
		 ...
		 */
		public function createDeleteBuilder($table){ }
